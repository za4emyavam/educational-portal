    ...
    return (
        <div className="flex flex-col mt-[150px] justify-center items-center">
            <div className="w-[640px] h-[582px] flex-col justify-center items-center gap-8 inline-flex">
                <div className="px-14 py-10 rounded-3xl border border-stone-500/opacity-50 flex-col justify-start items-start gap-2.5 flex">
                    <div className="flex-col justify-center items-center gap-10 flex">
                        <div className="text-center text-zinc-800 text-[32px] font-semibold font-['Nunito Sans']">Увійти</div>
                        {showErrorMessage &&
                            <div className="errorMessage">Помилка автентифікації. Перевірте свої облікові дані.</div>}
                        <div className="flex-col justify-start items-start gap-6 flex">
                            <div className="h-[87px] flex-col justify-start items-start gap-1 flex">
                                ...
                                <div className="w-[528px] h-14 relative rounded-xl border border-stone-500/opacity-30">
                                    <input className="w-[528px] h-14 rounded-xl border text-base font-normal" type="text" name="username"
                                           value={username} onChange={usernameOnChange}/>
                                </div>
                            </div>
                            <div className="h-[87px] flex-col justify-start items-start gap-1 flex">
                                <div className="pr-[8.86px] justify-start items-start gap-[327.14px] inline-flex">
                                    <div className="text-stone-500 text-base font-normal font-['Poppins']">Ваш пароль</div>
                                ...
                                <div className="w-[528px] h-14 relative rounded-xl border border-stone-500/opacity-30">
                                    <input className="w-[528px] h-14 relative rounded-xl border" type="password" name="password"
                                           value={password} onChange={passwordOnChange}/>
                                </div>
                            </div>
                            <div className="flex-col justify-center items-center gap-2 flex">
                                <button className="w-[528px] h-16 pt-[15px] pb-4 opacity-25 bg-neutral-900 rounded-[40px] justify-center items-center inline-flex"
                                        type="button" name="Login" onClick={handleSubmit}>
                                    <div className="justify-center items-center gap-2 inline-flex">
                                        <div className="text-center text-white text-[22px] font-semibold font-['Nunito Sans']">Авторизуватись</div>
                                    </div>
                                </button>
